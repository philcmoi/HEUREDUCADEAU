...
// VERSION CORRIGÉE - Upload d'images fonctionnel
...
function uploadImage($file) {
    // Configuration - Chemin relatif depuis le fichier admin_produits.php
    ...
    if (!isset($file) || !is_array($file) || $file['error'] === UPLOAD_ERR_NO_FILE) {
        error_log("uploadImage: Aucun fichier sélectionné");
    ...
    // 4. Vérifier que c'est une vraie image
    ...
    // 6. Vérifier que le dossier existe et est accessible
                ...
                if (addProduct($pdo, $data)) {
                    ...
                    if (!empty($_FILES['image']['name']) && $_FILES['image']['error'] !== UPLOAD_ERR_NO_FILE) {
                        ...
                        if (isset($upload_result['success'])) {
                            ...
                            error_log("Image enregistrée en BDD: " . $image_url);
                        } else {
                ...
                if (updateProduct($pdo, $id, $data)) {
                    ...
                    if (!empty($_FILES['image']['name']) && $_FILES['image']['error'] !== UPLOAD_ERR_NO_FILE) {
                        ...
                        if (isset($upload_result['success'])) {
                            ...
                            error_log("Upload réussi pour produit ID: " . $id . " - URL: " . $image_url);
                        } else {
                            $image_error = $upload_result['error'];
                        ...
                        <table>
                            ...
                            <tbody>
                                <?php foreach ($products as $product): 
                                    // Récupérer l'URL de l'image depuis le champ image_url ajouté dans getAllProducts()
                                    $image_url = !empty($product['image_url']) ? $product['image_url'] : 'https://via.placeholder.com/60x60?text=Pas+d\'image';
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <img src="<?php echo htmlspecialchars($image_url); ?>" 
                                             ...
                                             loading="lazy"
                                             decoding="async"
                                             onerror="this.onerror=null; this.src='https://via.placeholder.com/60x60?text=Erreur'; this.classList.remove('loading')">
                                    </td>
                                    ...
                                    <td class="price hide-mobile"><?php echo number_format($prix_ttc, 2, ',', ' '); ?> €</td>
                                    <td>
                ...
                <form method="POST" action="" enctype="multipart/form-data">
                    ...
                    <div class="form-row-2">
                        ...
                        <div class="form-group">
                            ...
                            <?php else: ?>
                                <small style="color: #666;">Sélectionnez une image pour le produit</small>
                            <?php endif; ?>
                ...
                <div class="detail-grid" style="display: grid; grid-template-columns: 1fr; gap: 20px;">
                    ...
                    <div>
                        <table class="info-table">
                            ...
                            <tr>
                                <th>Nom</th>
                                <tr><?php echo htmlspecialchars($product['nom']); ?></td>
                            </tr>
                            <tr>
                                <th>Slug</th>
            ...
            document.querySelectorAll('img').forEach(img => {
                img.addEventListener('error', function() {
                    if (!this.src.includes('placeholder')) {
                        this.src = 'https://via.placeholder.com/60x60?text=Erreur';
                    }
                });
            });
        });
