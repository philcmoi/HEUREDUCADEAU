                ...
                if (addProduct($pdo, $data)) {
                    ...
                    if (!empty($_FILES['image']['name']) && $_FILES['image']['error'] !== UPLOAD_ERR_NO_FILE) {
                        ...
                        if (isset($upload_result['success'])) {
                            ...
                            header('Location: admin_produits.php?action=list&message=added_with_image');
                            exit();
                        }
                    }
                ...
                if (updateProduct($pdo, $id, $data)) {
                    if (!empty($_FILES['image']['name']) && $_FILES['image']['error'] !== UPLOAD_ERR_NO_FILE) {
                        ...
                        if (isset($upload_result['success'])) {
                            ...
                            header('Location: admin_produits.php?action=list&message=updated_with_image');
                            exit();
                        }
                    }
...
if (isset($_GET['message'])) {
    switch ($_GET['message']) {
        ...
        case 'added_with_image': $message = 'Produit ajouté avec succès avec son image !'; break;
        case 'updated': $message = 'Produit modifié avec succès !'; break;
        case 'updated_with_image': $message = 'Produit modifié avec succès, image mise à jour !'; break;
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><code><?php echo htmlspecialchars($product['reference']); ?></code></td>
                                    <td>
