...
--
-- Hôte : localhost:3306
-- Généré le : mar. 26 mai 2026 à 17:16
...
(3, 'admin', '007', 'lhpp.philippe@gmail.com', 'superadmin', 'active', '2026-05-26 17:16:05', '2026-05-26 17:12:01', 0, 0, NULL, '2025-12-07 06:28:27', '2026-05-26 17:16:05');
...
(425, 34, 'livraison', 'Lor', 'Philippe', NULL, '116 rue de Javel', NULL, '75015', 'Paris', 'France', '0644982807', 1, '2026-05-18 02:35:49', 0);
...
(34, 'lhpp.philippe@gmail.com', NULL, 'Lor', 'Philippe', '0644982807', NULL, NULL, '2026-05-18 02:30:10', 'actif', 1, 'fkt289vkgr86d82bmi555pussa', 1, '2026-05-18 02:35:49', NULL, NULL);
...
(31, 'PROD-000002', '1 EURO', '1-euro-1', 'AZERTY', '1 EURO', '10.00', '20.00', 9, 2, 1, '', NULL, '', '', '', '', 0, 0, 0, 0, 0, '0.00', 0, 0, 1, 'actif', '2026-05-09 05:40:56', '2026-05-18 02:36:28');
...
(1, 'BIENVENUE10', 'pourcentage', '10.00', '0.00', NULL, 0, '2026-05-26 17:16:39', '2026-06-25 17:16:39', 1, '10% de réduction sur votre première commande', '2026-05-26 17:16:39'),
(2, 'LIVRAISONOFFERTE', 'livraison_gratuite', '0.00', '50.00', 100, 0, '2026-05-26 17:16:39', '2026-06-10 17:16:39', 1, 'Livraison gratuite dès 50€ d\'achat', '2026-05-26 17:16:39');
...
--
ALTER TABLE `adresses`
  MODIFY `id_adresse` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=426;
...
--
ALTER TABLE `commandes`
  MODIFY `id_commande` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=209;

--
-- AUTO_INCREMENT pour la table `commande_items`
--
ALTER TABLE `commande_items`
  MODIFY `id_item` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=236;
...
--
ALTER TABLE `images_produits`
  MODIFY `id_image` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;

--
-- AUTO_INCREMENT pour la table `logs`
--
ALTER TABLE `logs`
  MODIFY `id_log` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=473;

--
-- AUTO_INCREMENT pour la table `panier`
--
ALTER TABLE `panier`
  MODIFY `id_panier` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=477;

--
-- AUTO_INCREMENT pour la table `panier_items`
--
ALTER TABLE `panier_items`
  MODIFY `id_item` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=91;
...
--
ALTER TABLE `produits`
  MODIFY `id_produit` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;
...
--
ALTER TABLE `transactions`
  MODIFY `id_transaction` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=93;
