...
--
-- Hôte : localhost:3306
-- Généré le : ven. 12 déc. 2025 à 13:59
...
INSERT INTO `adresses` (`id_adresse`, `id_client`, `type_adresse`, `nom`, `prenom`, `societe`, `adresse`, `complement`, `code_postal`, `ville`, `pays`, `telephone`, `principale`, `date_creation`) VALUES
(28, 11, 'livraison', 'MADOIRE', 'François', NULL, '116 rue Javel', NULL, '75015', 'Paris', 'France', '34555', 1, '2025-12-12 02:40:13');
...
INSERT INTO `clients` (`id_client`, `email`, `mot_de_passe`, `nom`, `prenom`, `telephone`, `date_naissance`, `genre`, `date_inscription`, `statut`, `newsletter`, `dernier_connexion`, `token_reset`, `token_expiration`) VALUES
(11, 'lhpp.philippe@gmail.com', 'temp_password', 'MADOIRE', 'François', '34555', NULL, NULL, '2025-12-12 02:40:13', 'actif', 1, NULL, NULL, NULL);
...
INSERT INTO `commandes` (`id_commande`, `numero_commande`, `id_client`, `id_adresse_livraison`, `id_adresse_facturation`, `statut`, `sous_total`, `frais_livraison`, `reduction`, `total_ttc`, `mode_paiement`, `statut_paiement`, `reference_paiement`, `transporteur`, `numero_suivi`, `instructions`, `date_commande`, `date_paiement`, `date_expedition`, `date_livraison_estimee`, `date_livraison_reelle`) VALUES
(40, 'CMD-202512-000001', 11, 28, 28, 'en_attente', '34.90', '4.90', '0.00', '39.80', 'paypal', 'en_attente', NULL, NULL, NULL, NULL, '2025-12-12 02:40:13', NULL, NULL, NULL, NULL);
...
CREATE TRIGGER `before_commande_insert` BEFORE INSERT ON `commandes` FOR EACH ROW BEGIN
    ...
    SELECT COALESCE(MAX(SUBSTRING_INDEX(SUBSTRING_INDEX(numero_commande, '-', 3), '-', -1)), 0) + 1 
    INTO next_num 
    FROM commandes 
    WHERE numero_commande LIKE CONCAT('CMD-', DATE_FORMAT(NOW(), '%Y%m'), '-%');
    
    -- Si aucune commande ce mois-ci, commencer à 1
...
(40, 40, 1, NULL, 'REF001', 'Bougie parfumée \"Élégance\"', 1, '29.08', '34.90', '20.00', NULL);
...
CREATE TABLE `logs` (
  `id_log` int NOT NULL,
  `type_log` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
...
(16, 'commande', 'info', 'Commande créée #CMD-202512-000001', 8, NULL, NULL, NULL, NULL, '2025-12-11 10:52:49'),
(17, 'commande', 'info', 'Commande créée #CMD-202512-000002', 8, NULL, NULL, NULL, NULL, '2025-12-11 12:20:35'),
(18, 'commande', 'info', 'Commande créée #CMD-202512-000003', 8, NULL, NULL, NULL, NULL, '2025-12-11 12:22:59'),
(19, 'commande', 'info', 'Commande créée #CMD-202512-000004', 8, NULL, NULL, NULL, NULL, '2025-12-11 13:11:49'),
(20, 'commande', 'info', 'Commande créée #CMD-202512-000005', 8, NULL, NULL, NULL, NULL, '2025-12-11 14:57:34'),
(21, 'commande', 'info', 'Commande créée #CMD-202512-000006', 8, NULL, NULL, NULL, NULL, '2025-12-11 15:38:06'),
(22, 'commande', 'info', 'Commande créée #CMD-202512-000007', 8, NULL, NULL, NULL, NULL, '2025-12-12 00:49:23'),
(23, 'commande', 'info', 'Commande créée #CMD-202512-000008', 8, NULL, NULL, NULL, NULL, '2025-12-12 00:53:01'),
(24, 'commande', 'info', 'Commande créée #CMD-202512-000009', 8, NULL, NULL, NULL, NULL, '2025-12-12 01:05:17'),
(25, 'commande', 'info', 'Commande créée #CMD-202512-000010', 8, NULL, NULL, NULL, NULL, '2025-12-12 01:16:08'),
(26, 'commande', 'info', 'Commande créée #CMD-202512-000011', 8, NULL, NULL, NULL, NULL, '2025-12-12 01:25:24'),
(27, 'commande', 'info', 'Commande créée #CMD-202512-000012', 8, NULL, NULL, NULL, NULL, '2025-12-12 01:29:15'),
(28, 'commande', 'info', 'Commande créée #CMD-202512-000013', 8, NULL, NULL, NULL, NULL, '2025-12-12 01:36:03'),
(29, 'commande', 'info', 'Commande créée #CMD-202512-000014', 8, NULL, NULL, NULL, NULL, '2025-12-12 01:42:36'),
(30, 'commande', 'info', 'Commande créée #CMD-202512-000015', 9, NULL, NULL, NULL, NULL, '2025-12-12 01:57:59'),
(31, 'commande', 'info', 'Commande créée #CMD-202512-000001', 10, NULL, NULL, NULL, NULL, '2025-12-12 02:05:48'),
(32, 'commande', 'info', 'Commande créée #CMD-202512-000001', 11, NULL, NULL, NULL, NULL, '2025-12-12 02:40:13');
...
INSERT INTO `methodes_paiement` (`id_methode`, `nom`, `code`, `description`, `frais_pourcentage`, `frais_fixe`, `actif`, `ordre`, `logo`, `date_creation`) VALUES
(1, 'Carte Bancaire', 'carte', 'Paiement sécurisé par carte bancaire', '1.50', '0.30', 1, 1, NULL, '2025-12-12 13:58:58'),
(2, 'PayPal', 'paypal', 'Paiement via votre compte PayPal', '2.00', '0.00', 1, 2, NULL, '2025-12-12 13:58:58'),
(3, 'PayPal Email', 'paypal_email', 'Paiement via email PayPal', '2.00', '0.00', 1, 3, NULL, '2025-12-12 13:58:58'),
(4, 'Virement Bancaire', 'virement', 'Virement bancaire', '0.00', '0.00', 1, 4, NULL, '2025-12-12 13:58:58');
...
(1, 'REF001', 'Bougie parfumée \"Élégance\"', 'bougie-parfumee-elegance', 'Bougie artisanale parfum vanille et santal. 50h de combustion.', 'Bougie artisanale parfum vanille et santal', '29.08', '20.00', 73, 10, 1, 'Artisanat Français', NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, '0.00', 0, 0, 0, 'actif', '2025-12-07 16:56:32', '2025-12-12 02:40:13'),
(2, 'REF002', 'Coffret gourmand \"Délice\"', 'coffret-gourmand-delice', 'Sélection des meilleures spécialités françaises. Emballage cadeau inclus.', 'Sélection de spécialités françaises', '41.58', '20.00', 47, 10, 1, 'Saveurs de France', NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, '0.00', 0, 0, 0, 'actif', '2025-12-07 16:56:32', '2025-12-11 10:21:07'),
...
(4, 'REF004', 'Set bijoux \"Lumière\"', 'set-bijoux-lumiere', 'Collier, boucles d\'oreilles et bracelet assortis. Argent 925.', 'Set bijoux en argent 925', '1000.00', '20.00', 18, 5, 1, 'Bijoux d\'Exception', NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, '0.00', 0, 0, 0, 'actif', '2025-12-07 16:56:32', '2025-12-12 01:57:59');
...
--
-- Structure de la table `tokens_paiement`
--

CREATE TABLE `tokens_paiement` (
...
CREATE TABLE `transactions` (
  ...
  `statut` varchar(20) DEFAULT 'en_attente' COMMENT 'en_attente, paye, echec, annule, rembourse',
  `reference_paiement` varchar(255) DEFAULT NULL,
  `donnees_paiement` json DEFAULT NULL COMMENT 'Données brutes du paiement',
  `date_creation` datetime DEFAULT CURRENT_TIMESTAMP,
...
--
-- Index pour la table `tokens_paiement`
--
ALTER TABLE `tokens_paiement`
...
--
ALTER TABLE `adresses`
  MODIFY `id_adresse` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;
...
--
ALTER TABLE `commandes`
  MODIFY `id_commande` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=41;

--
-- AUTO_INCREMENT pour la table `commande_items`
--
ALTER TABLE `commande_items`
  MODIFY `id_item` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=41;
...
--
ALTER TABLE `methodes_paiement`
  MODIFY `id_methode` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
-- AUTO_INCREMENT pour la table `tokens_paiement`
--
ALTER TABLE `tokens_paiement`
